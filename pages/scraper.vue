<template>
  <DashBoardHeader title="Scraper Dashboard">
    <div
      v-if="loadingData || !botCard"
      class="place-items-center place-content-center my-15"
    >
      <UProgress animation="carousel" color="secondary" v-show="loadingData" />
    </div>
    <!-- When Loaded -->
    <div v-else class="mt-10">
      ...
      <!-- General Metrics -->
      <div
        v-if="generalMetricskeys"
        class="mb-10 flex flex-wrap gap-2 md:gap-5 items-center justify-center"
      >
